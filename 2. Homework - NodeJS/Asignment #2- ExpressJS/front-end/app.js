...
const deleteUser = (company) => {
    ...
    .then(result => {
        ...
        let deletedCompany = result.find(res => res.company.name === company);
            ...
            inner += `<div class="col-md-4 col-sd-6 my-3" >
                    <div class="card">
                        <div class="card-body bg-light">
                            ...
                            <button type="button" class="btn btn-danger" id="${user.company.name}">Delete</button>
                        </div>
                    </div>
                </div>`;
    });
